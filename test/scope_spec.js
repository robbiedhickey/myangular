...
describe('Scope', function () {
  ...
  describe('$digest', function () {
    ...
    it('triggers chained watchers in the same digest', function () {
      ...
      // register dependent watcher first
      scope.$watch(
    ...
    // need to add new watches to the beginning and reverse iteration to be end-to-beginning
  ...
  describe('inheritance', function () {
    ...
    it('is no longer digested when $destroy is called', function () {
      var parent = new Scope();
      var child = parent.$new();
      child.aValue = [1, 2, 3];
      child.counter = 0;
      ...
      child.$watch(
        function (scope) { return child.aValue; },
        function (newValue, oldValue, scope) {
          scope.counter++;
        },
        true
